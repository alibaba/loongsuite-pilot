...
| `multimodal.uploadMode` | **Experimental.** Multimodal upload policy. `none` (default) disables; `input` / `output` / `both` select conversion surfaces. See [Multimodal Collection](multimodal.md). |
