...
# LoongSuite Pilot AI Coding Agent 接入指南（云监控 2.0）

本文介绍如何通过 LoongSuite Pilot 将开发者本机的 AI Coding Agent 数据接入目标平台（云监控 2.0）。接入后，您可以查看 AI Coding Agent 的会话、模型调用、工具调用、Token 用量、日志和 Trace 数据，用于团队使用分析、审计和可观测分析。
