...
cmd_help() {
    ...
    echo "  menubar start   Start the macOS menu bar app without restarting the collector"
    echo "  menubar stop    Stop only the macOS menu bar app (keep the collector running)"
