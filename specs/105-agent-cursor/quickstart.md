...
`/Users/<your-user>/.ai-agent-collector/hooks/cursor-hook.sh`
...
```bash
export AAC_DATA_DIR="/tmp/aac-cursor-hook-test"
rm -rf "$AAC_DATA_DIR"
...
- stdout 返回 `{}`  
- 生成文件：`/tmp/aac-cursor-hook-test/logs/cursor-hook/history/cursor-YYYY-MM-DD.jsonl`  
